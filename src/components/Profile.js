        ...
        <div>
          ...
          <div className="card m-5 d-flex justify-content-center" style={{'width':'35vw'}}>
            ...
            <div className="card-body">
              ...
              <hr className='border border-info border-1 mb-0'/>
            ...
            <div className="d-flex justify-content-center w-100">
              <button className="btn btn-info text-uppercase fw-bold mb-3 px-0 " sytle={{'width':'15vw'}} type="submit" onClick={()=>updateUser()}>
                Update
              </button>
            </div>
          </div>
